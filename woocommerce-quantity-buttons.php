...
add_action(
	...
	function () {
		...
		wp_enqueue_script( 'smntcswcqb-script', plugins_url( 'custom.js', __FILE__ ), array( 'jquery' ), SMNTCSWCQB_VERSION, true );
		wp_enqueue_style( 'smntcswcqb-style', plugins_url( 'custom.css', __FILE__ ), null, SMNTCSWCQB_VERSION, 'screen' );
